...
<form class="cart" method="post" enctype='multipart/form-data'>
					...
					<tr>
						...
						<td class="label">
							<label for="product-<?php echo esc_attr( $product_id ); ?>">
								<?php $king->ext['pr']( $product->is_visible() ? '<a href="' . get_permalink() . '">' . get_the_title() . '</a>' : get_the_title() ); ?>
							</label>
						</td>
						...
						<td class="price">
							<?php
								$king->ext['pr']( $product->get_price_html() );
	...
	<?php if ( $quantites_required ) : ?>
		...
		<button type="submit" class="single_add_to_cart_button button alt"><?php $king->ext['pr']( $product->single_add_to_cart_text() ); ?></button>
